...
interface InterestCostChartProps {
  comparison: ComparisonResult;
}

export function InterestCostChart({ comparison }: InterestCostChartProps) {
    ...
    try {
      ...
      for (let i = 0; i < maxLength; i++) {
        ...
        data.push({
          ...
          baseline: baselineSummary ? baselineSummary.interest_accrued.toNumber() : null,
          scenario: scenarioSummary ? scenarioSummary.interest_accrued.toNumber() : null,
        });
      }
  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-6 mb-6">
      <h3 className="text-lg font-bold text-gray-800 mb-4">Monthly Interest Cost Over Time</h3>
      <ResponsiveContainer width="100%" height={500}>
        <LineChart data={chartData} margin={{ left: 130, right: 30, top: 10, bottom: 120 }}>
          ...
          <YAxis 
            ...
            label={{ value: 'Interest (R)', angle: -90, position: 'insideLeft', offset: -20, style: { textAnchor: 'middle', fontSize: 16, fontWeight: 500 } }}
          />
          <Tooltip 
