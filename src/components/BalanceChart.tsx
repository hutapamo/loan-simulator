...
export function BalanceChart({ comparison }: BalanceChartProps) {
    ...
    try {
      ...
      for (let i = 0; i < maxLength; i++) {
        ...
        data.push({
          ...
          baseline: baselineSummary ? baselineSummary.month_end_principal.toNumber() : null,
          scenario: scenarioSummary ? scenarioSummary.month_end_principal.toNumber() : null,
        });
      }
  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-6 mb-6">
      <h3 className="text-lg font-bold text-gray-800 mb-4">Remaining Balance Over Time</h3>
      <ResponsiveContainer width="100%" height={500}>
        <LineChart data={chartData} margin={{ left: 130, right: 30, top: 10, bottom: 120 }}>
          ...
          <YAxis 
            ...
            label={{ value: 'Principal (R)', angle: -90, position: 'insideLeft', offset: -20, style: { textAnchor: 'middle', fontSize: 16, fontWeight: 500 } }}
          />
          <Tooltip 
